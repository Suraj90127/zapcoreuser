        ...
        },
        {
          ...
          params: [
            ...
            },
            {
              ...
              type: "string",
              required: true,
              description: "Match ID (e.g., match_123)",
              location: "query",
            },
          ],
        },
      ...
      "Game Management": [
        {
          ...
          params: [
            ...
            },
            {
              name: "provider_list",
              type: "boolean",
              description: "Get provider list (1/0)",
              location: "query",
            },
            {
              name: "gametype_list",
              type: "boolean",
              description: "Get game types (1/0)",
              location: "query",
            },
            {
              name: "provider",
      ...
      "Game Launch": [
        {
          ...
          body: [
            ...
            },
            {
              ...
              type: "string",
              required: true,
              description: "Player ID (unique identifier for the player)",
              location: "body",
            },
            {
              ...
              type: "number",
              required: true,
              description: "Initial balance to credit to player",
              location: "body",
            },
          ],
        },
          ...
          body: [
            {
              name: "playerid",
              type: "string",
              description: "Filter by player (optional)",
              location: "body",
            },
            {
              name: "page",
      ...
      "Final Result": [
        {
          ...
          body: [
            ...
            },
            {
              ...
              type: "number",
              required: true,
              description: "Event ID (same as gameId)",
              location: "body",
            },
            {
              name: "event_name",
            ...
            },
            {
              ...
              type: "string",
              required: true,
              description: "Market name (e.g., Match Winner)",
              location: "body",
            },
            {
              name: "gameName",
            ...
            },
            {
              name: "market_type",
              type: "string",
              description: "Market type (optional)",
              location: "body",
            },
          ],
        },
...
const MIDDLEWARE_DOCS = {
    ...
    validationSteps: [
      {
        ...
        icon: Key,
        description: "Checks if key is provided and valid",
      },
      {
        step: "User Status",
        icon: Users,
        description: "Verifies user account is active",
      },
      {
        step: "IP Whitelist",
        icon: Shield,
        description: "Validates request IP against whitelist",
      },
      {
        step: "Domain Check",
        icon: Globe,
        description: "Ensures x-domain header matches registered domain",
      },
      {
        step: "Provider Access",
        icon: Gamepad2,
        description: "Verifies user has access to requested providers",
      },
    ],
    errorResponses: [
      ...
      {
        code: 403,
        message: "Domain not configured / Access denied",
        icon: Globe2,
      },
  ...
  cricketGameValidate: {
    ...
    description:
      "Validates access for cricket-specific endpoints including result APIs",
    icon: Gamepad2,
    color: "emerald",
    required: {
      query: [
    ...
    validationSteps: [
      ...
      },
      {
        step: "Balance Check",
        icon: CreditCard,
        description: "Ensures cricket balance > 0",
      },
      {
        step: "Domain Check",
        icon: Globe,
...
const authFlowDiagram = [
  {
    step: "1. API Key",
    icon: Key,
    description: "Validate API key from query params",
  },
  {
    step: "2. User Status",
    icon: Users,
  ...
  },
  {
    step: "3. IP Whitelist",
    icon: Shield,
    description: "Verify request IP matches whitelist",
  },
  {
    step: "4. Domain Check",
    icon: Globe,
    description: "Validate x-domain header matches user domain",
  },
  {
    step: "5. Balance Check",
    icon: Database,
    description: "Verify sufficient balance (if applicable)",
  },
];
  ...
  return (
    <div className={`min-h-screen ${theme === "dark" ? "dark" : ""}`}>
      ...
      <div className={`flex h-screen ${classes.bg} mt-20`}>
        {/* Sidebar */}
        <aside
          className={`w-80 ${classes.sidebar} border-r ${classes.border} overflow-y-auto shadow-xl`}
        >
          <div className="p-6">
            <div className="flex items-center gap-3 mb-8">
              <div
                className={`w-10 h-10 bg-gradient-to-br ${classes.gradient} rounded-xl flex items-center justify-center shadow-lg transform hover:scale-105 transition-transform`}
              >
                <Zap className="w-5 h-5 text-white" />
              </div>
              <div>
                <h1
                  className={`text-xl font-bold bg-gradient-to-r ${classes.gradient} bg-clip-text text-transparent`}
                >
                  playnosys API
                </h1>
            ...
            <div className="mb-6 space-y-2">
              ...
              >
                <Shield
                  className={`w-5 h-5 ${theme === "dark" ? "text-indigo-400" : "text-indigo-600"} group-hover:scale-110 transition-transform`}
                />
                <span className={`font-medium text-sm ${classes.text}`}>
                  Authentication Flow
                </span>
                <ChevronDown
                  className={`w-4 h-4 ml-auto transition-transform ${showAuthFlow ? "rotate-180" : ""} ${classes.textMuted}`}
                />
              </button>

              {showAuthFlow && (
                <div
                  className={`mt-3 p-4 ${classes.bgSecondary} rounded-xl border ${classes.border} animate-slideDown`}
                >
                  {authFlowDiagram.map((item, idx) => (
                    ...
                    >
                      <div
                        className={`w-6 h-6 rounded-full ${theme === "dark" ? "bg-indigo-900/50" : "bg-indigo-100"} flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform`}
                      >
                        <item.icon
                          className={`w-3 h-3 ${theme === "dark" ? "text-indigo-400" : "text-indigo-600"}`}
                        />
                      </div>
                      <div>
            ...
            <div className="mb-6">
              <h3
                className={`text-xs font-semibold uppercase ${classes.textMuted} mb-2 px-2`}
              >
                Middleware
              </h3>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 text-left">
                      ...
                      <p
                        className={`text-xs ${showMiddlewareDetails === key ? "text-white/80" : classes.textMuted}`}
                      >
                              ...
                              {data.endpoints[sub].map((ep, i) => (
                                ...
                                >
                                  <div className="flex items-center gap-2">
                                    <span
                                      className={`px-2 py-0.5 rounded text-[10px] font-mono ${getMethodColor(ep.method)}`}
                                    >
                                      {ep.method}
                                    </span>
            ...
            <div
              className={`mt-8 p-4 ${classes.bgSecondary} rounded-xl border ${classes.border}`}
            >
              <p
                className={`text-xs ${classes.textMuted} mb-2 flex items-center gap-1`}
              >
                <Server size={12} />
                BASE URLs
              </p>
              <div className="space-y-2">
                <div
                  className={`flex items-center gap-2 ${classes.card} p-2 rounded-lg border ${classes.border} group hover:border-blue-500 transition-colors`}
                >
                  <code className={`text-xs flex-1 ${classes.text} font-mono`}>
                    Main API: {API_CONFIG.baseUrl}
                  </code>
                  <button
                  ...
                  >
                    {copied ? (
                      ...
                      <Copy size={14} className={classes.textMuted} />
                    )}
                  </button>
                </div>
              </div>
          ...
          {!selectedEndpoint && !showMiddlewareDetails ? (
            <div className="h-full flex items-center justify-center p-8">
              <div className="max-w-4xl text-center animate-fadeIn">
                <div
                  className={`w-28 h-28 bg-gradient-to-br ${classes.gradient} rounded-3xl flex items-center justify-center mx-auto mb-8 shadow-2xl transform hover:scale-110 transition-transform`}
                >
                  <Zap className="w-14 h-14 text-white" />
                </div>
                <h2
                  className={`text-5xl font-bold mb-4 bg-gradient-to-r ${classes.gradient} bg-clip-text text-transparent`}
                >
                  playnosys API Documentation
                </h2>
                <p
                  className={`${classes.textSecondary} mb-8 text-lg max-w-2xl mx-auto`}
                >
                  Integrate cricket, tennis, soccer data, casino games, and
                  betting results with our powerful API. Secure, fast, and
                  reliable.
                </p>
                  ...
                  {[
                    {
                      icon: Shield,
                      label: "IP Whitelist",
                      desc: "Secure access control with IP validation",
                      gradient: "from-blue-500 to-cyan-500",
                    },
                    {
                      icon: Zap,
                      label: "Fast Integration",
                      desc: "Quick setup with comprehensive docs",
                      gradient: "from-amber-500 to-orange-500",
                    },
                    {
                      icon: Trophy,
                      label: "Bet Settlement",
                      desc: "Real-time result and fancy bet settlement",
                      gradient: "from-yellow-500 to-amber-500",
                    },
                  ].map((item, i) => (
                    <div
                      key={i}
                      className={`p-6 ${classes.card} rounded-2xl shadow-sm border ${classes.border} transform hover:scale-105 transition-all duration-300 group`}
                    >
                      <div
                        className={`w-12 h-12 bg-gradient-to-br ${item.gradient} rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:rotate-12 transition-transform`}
                      >
                        <item.icon className="w-6 h-6 text-white" />
                      </div>
                      <p
                        className={`font-semibold text-base ${classes.text} mb-1`}
                      >
                        {item.label}
                      </p>
                ...
                <div className="mt-12 flex justify-center gap-4">
                  <div
                    className={`px-4 py-2 ${classes.bgSecondary} rounded-full border ${classes.border} flex items-center gap-2`}
                  >
            ...
            <div className="p-8 animate-fadeIn">
              <div
                className={`${classes.card} rounded-2xl p-8 shadow-sm border ${classes.border} mb-6`}
              >
                <div className="flex items-center gap-4 mb-6">
                  <div
                    className={`w-16 h-16 bg-gradient-to-br from-${MIDDLEWARE_DOCS[showMiddlewareDetails].color}-600 to-${MIDDLEWARE_DOCS[showMiddlewareDetails].color}-700 rounded-2xl flex items-center justify-center shadow-lg`}
                  >
                    {React.createElement(
                      MIDDLEWARE_DOCS[showMiddlewareDetails].icon,
                      { size: 32, className: "text-white" },
                    )}
                  </div>
                  <div>
                    <h1 className={`text-3xl font-bold ${classes.text} mb-2`}>
                      {MIDDLEWARE_DOCS[showMiddlewareDetails].name}
                    </h1>
                    <p className={classes.textSecondary}>
                      {MIDDLEWARE_DOCS[showMiddlewareDetails].description}
                    </p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                  {/* Query Parameters */}
                  <div
                    className={`${classes.bgSecondary} rounded-xl p-6 border ${classes.border}`}
                  >
                    <h3
                      className={`font-semibold mb-4 flex items-center gap-2 ${classes.text}`}
                    >
                    ...
                    <div className="space-y-3">
                      {MIDDLEWARE_DOCS[
                        showMiddlewareDetails
                      ].required.query.map((param, idx) => (
                        <div key={idx} className="flex items-start gap-3">
                          <div
                            className={`px-2 py-1 rounded ${getLocationBadge("query")} text-xs font-mono`}
                          >
                            {param.name}
                          </div>
                  ...
                  >
                    ...
                    <div className="space-y-3">
                      {MIDDLEWARE_DOCS[
                        showMiddlewareDetails
                      ].required.headers.map((header, idx) => (
                        <div key={idx} className="flex items-start gap-3">
                          <div
                            className={`px-2 py-1 rounded ${getLocationBadge("header")} text-xs font-mono`}
                          >
                            {header.name}
                          </div>
                          <div className="flex-1">
                ...
                {/* IP Requirement */}
                <div
                  className={`mb-8 p-4 ${classes.bgSecondary} rounded-xl border ${classes.border}`}
                >
                  <h3
                    className={`font-semibold mb-3 flex items-center gap-2 ${classes.text}`}
                  >
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className={`text-xs ${classes.textMuted}`}>
                        {
                          MIDDLEWARE_DOCS[showMiddlewareDetails].required.ip
                            .description
                        }
                      </p>
                    </div>
                ...
                <div className="mb-8">
                  ...
                  <div className="relative">
                    ...
                    {MIDDLEWARE_DOCS[showMiddlewareDetails].validationSteps.map(
                      (step, idx) => (
                        <div
                          key={idx}
                        ...
                        >
                          <div
                            className={`w-8 h-8 rounded-full bg-gradient-to-br from-${MIDDLEWARE_DOCS[showMiddlewareDetails].color}-600 to-${MIDDLEWARE_DOCS[showMiddlewareDetails].color}-700 flex items-center justify-center z-10 shadow-lg`}
                          >
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {MIDDLEWARE_DOCS[showMiddlewareDetails].errorResponses.map(
                      (error, idx) => (
                        <div
                          key={idx}
                          className={`p-3 ${classes.bgSecondary} rounded-lg border ${classes.border} flex items-start gap-3`}
                        >
                          <div
                          ...
                          >
                            {React.createElement(error.icon, {
                              size: 14,
                              className:
                                error.code === 400
                                  ? "text-amber-600"
            ...
            selectedEndpoint && (
              <div className="p-8 animate-fadeIn">
                {/* Endpoint Header */}
                <div
                  className={`${classes.card} rounded-2xl p-6 shadow-sm border ${classes.border} mb-6 transform hover:scale-[1.02] transition-all duration-300`}
                >
                  <div className="flex items-center justify-between mb-4 flex-wrap gap-4">
                    <div className="flex items-center gap-3 flex-wrap">
                      <span
                        className={`px-3 py-1.5 rounded-lg text-sm font-mono ${getMethodColor(selectedEndpoint.method)}`}
                      >
                        {selectedEndpoint.method}
                      </span>
                      <code
                        className={`text-lg font-mono ${classes.bgSecondary} px-3 py-1.5 rounded-lg ${classes.text} border ${classes.border}`}
                      >
                        {selectedEndpoint.path}
                      </code>
                      {selectedEndpoint.auth && (
                        <span
                          className={`px-2 py-1 rounded-lg text-xs bg-purple-100 text-purple-700 border border-purple-200`}
                        >
                          {selectedEndpoint.auth}
                        </span>
                      )}
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        onClick={() => {
                          const baseUrl =
                            openMain === "Cricket Result"
                              ? API_CONFIG.resultbaseUrl
                              : API_CONFIG.baseUrl;
                      ...
                      >
                        ...
                        {copied ? (
                          ...
                          <Copy size={16} className={classes.textMuted} />
                        )}
                      </button>
                    </div>
                  </div>

                  <p className={`${classes.textSecondary} text-base mb-4`}>
                  ...
                  <div className="flex flex-wrap gap-4 text-sm">
                    <div className="flex items-center gap-2">
                      ...
                      <code
                        className={`${classes.bgSecondary} px-2 py-1 rounded text-xs font-mono ${classes.text} border ${classes.border}`}
                      >
                        {selectedEndpoint.auth}
                      </code>
                    </div>
                ...
                <div className=" flex justify-between">
                  {/* Tabs */}
                  <div
                    className={`flex gap-1 mb-6 ${classes.bgSecondary} p-1 rounded-xl shadow-sm border ${classes.border} w-fit overflow-x-auto`}
                  >
                    {[
                ...
                <div className="grid grid-cols-12 gap-6">
                  ...
                  <div className="space-y-6 col-span-12 lg:col-span-5">
                    {/* Language Selector */}
                    <div
                      className={`${classes.card} rounded-2xl p-4 shadow-sm border ${classes.border}`}
                    >
                      {/* Language Selector */}

                      <div
                        className={`flex gap-1 ${classes.bgSecondary} p-1 rounded-lg border ${classes.border}`}
                      >
                      ...
                      <div
                        className={`${classes.codeBg} rounded-xl border ${classes.border} overflow-hidden my-5`}
                      >
                        <div className="flex items-center gap-2 px-4 py-2 bg-black/20 border-b border-gray-700">
                          <div className="w-3 h-3 rounded-full bg-red-500"></div>
                          <div className="w-3 h-3 rounded-full bg-yellow-500"></div>
                          <div className="w-3 h-3 rounded-full bg-green-500"></div>
                          <span className={`text-xs ${classes.textMuted} ml-2`}>
                            example.
                        ...
                        <pre className="text-green-400 p-4 text-xs overflow-x-auto font-mono">
                          {(() => {
                            const template =
                              codeExamples[selectedEndpoint.method]?.[
                                selectedLanguage
                              ];
                            if (!template) return "";
                            ...
                            if (
                              ...
                              selectedEndpoint.body.forEach((param) => {
                                if (param.type === "number")
                                  bodyExample[param.name] = 12345678;
                                else if (param.type === "boolean")
                                  bodyExample[param.name] = true;
                                else if (param.name === "event_name")
                                  bodyExample[param.name] =
                                    "India vs Australia";
                                else if (param.name === "market_name")
                                  bodyExample[param.name] = "Match Winner";
                                else if (param.name === "gameName")
                                  bodyExample[param.name] = "Cricket";
                          ...
                          if (
                            ...
                            selectedEndpoint.body.forEach((param) => {
                              if (param.type === "number")
                                ...
                                bodyExample[param.name] = "India vs Australia";
                              else if (param.name === "market_name")
                                bodyExample[param.name] = "Match Winner";
                              else if (param.name === "gameName")
                                bodyExample[param.name] = "Cricket";
                    ...
                    {/* Quick Tips */}
                    <div
                      className={`bg-gradient-to-br ${classes.gradient} rounded-2xl p-6 text-white shadow-lg transform hover:scale-[1.02] transition-all duration-300`}
                    >
                    ...
                    {/* Rate Limits */}
                    <div
                      className={`${classes.card} rounded-2xl p-6 shadow-sm border ${classes.border}`}
                    >
                      <h3
                        className={`font-semibold mb-4 flex items-center gap-2 ${classes.text}`}
                      >
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-700">
                          ...
                          <span
                            className={`font-semibold ${classes.text} bg-gradient-to-r from-purple-500 to-purple-600 bg-clip-text text-transparent`}
                          >
                            10
                          </span>
                        </div>
                        <div
                          className={`mt-4 p-4 ${theme === "dark" ? "bg-yellow-900/30 border-yellow-800" : "bg-yellow-50 border-yellow-200"} rounded-xl border`}
                        >
                          <p
                            className={`text-xs ${theme === "dark" ? "text-yellow-300" : "text-yellow-800"} flex items-start gap-2`}
                          >
                            <AlertCircle
                              size={14}
                  ...
                  <div className="space-y-6 col-span-12 lg:col-span-7">
                    <div>
                      {activeTab === "docs" && (
                        <>
                          {/* Description Card */}
                          <div
                            className={`${classes.card} rounded-2xl p-6 shadow-sm border ${classes.border} transform hover:scale-[1.02] transition-all duration-300`}
                          >
                            <h3
                              className={`font-semibold mb-4 flex items-center gap-2 ${classes.text}`}
                            >
                            ...
                            <p
                              className={`${classes.textSecondary} text-sm mb-4 leading-relaxed`}
                            >
                              {selectedEndpoint.description}
                            </p>
                            <div
                              className={`${theme === "dark" ? "bg-blue-900/30" : "bg-blue-50"} p-4 rounded-xl border ${theme === "dark" ? "border-blue-800" : "border-blue-100"}`}
                            >
                              <p
                                className={`text-sm ${theme === "dark" ? "text-blue-300" : "text-blue-800"} flex items-start gap-2`}
                              >
                                <Info
                                  size={16}
                                  className="flex-shrink-0 mt-0.5"
                                />
                                <span>
                                  <strong>Note:</strong> All requests require
                                  API key and x-domain header for security.
                                </span>
                              </p>
                            </div>
                          </div>
                              ...
                              <div className="space-y-3">
                                ...
                                {selectedEndpoint.params &&
                                  selectedEndpoint.params.length > 0 && (
                                    <>
                                      <h4
                                        className={`text-xs font-semibold ${classes.textMuted} mb-2`}
                                      >
                                        Query Parameters
                                      </h4>
                                      {selectedEndpoint.params.map(
                                        (param, i) => (
                                          <div
                                            key={`param-${i}`}
                                            className={`flex items-start gap-3 p-3 ${classes.bgSecondary} rounded-lg border ${classes.border} hover:border-blue-500 transition-colors`}
                                          >
                                            <div className="min-w-[140px]">
                                              <div className="flex items-center gap-2 mb-1">
                                                <code
                                                  className={`text-sm font-mono ${classes.card} px-2 py-1 rounded border ${classes.border}`}
                                                >
                                                  {param.name}
                                                </code>
                                                {param.required && (
                                              ...
                                              {param.location && (
                                                <span
                                                  className={`text-xs px-1.5 py-0.5 rounded ${getLocationBadge(param.location)}`}
                                                >
                                                  {param.location}
                                                </span>
                                              )}
                                            ...
                                            <div className="flex-1">
                                              <p
                                                className={`text-sm ${classes.textSecondary} mb-1`}
                                              >
                                                {param.description}
                                              </p>
                                              <p
                                ...
                                {selectedEndpoint.method === "POST" &&
                                  ...
                                  selectedEndpoint.body.length > 0 && (
                                    <>
                                      <h4
                                        className={`text-xs font-semibold ${classes.textMuted} mb-2 mt-4`}
                                      >
                                        Body Parameters
                                      </h4>
                        ...
                        >
                          ...
                          {selectedEndpoint.params &&
                            selectedEndpoint.params.length > 0 && (
                              <div className="mb-6">
                                <h4
                                  className={`text-sm font-medium ${classes.text} mb-3 flex items-center gap-2`}
                                >
                                  <Key size={16} />
                                  Query Parameters
                                </h4>
                                {selectedEndpoint.params.map((param, i) => (
                                  <div
                                    key={`param-${i}`}
                                    className={`p-4 ${classes.bgSecondary} rounded-lg border ${classes.border} mb-3`}
                                  >
                                    <div className="flex items-center gap-2 mb-2 flex-wrap">
                                      <code
                                        className={`text-sm font-mono ${classes.text}`}
                                      >
                                        {param.name}
                                      </code>
                                      {param.required && (
                                      ...
                                      {param.location && (
                                        <span
                                          className={`text-xs px-2 py-0.5 rounded ${getLocationBadge(param.location)}`}
                                        >
                                          {param.location}
                                        </span>
                                      )}
                                    ...
                                    <p
                                      className={`text-sm ${classes.textSecondary} mb-3`}
                                    >
                                      {param.description}
                                    </p>
                                    <input
                      ...
                      {activeTab === "auth" && (
                        ...
                        >
                          ...
                          <div className="space-y-4">
                            <div
                              className={`p-4 ${classes.bgSecondary} rounded-xl border ${classes.border}`}
                            >
                              <div className="flex items-center gap-2 mb-3">
                                ...
                                />
                                <span
                                  className={`font-medium text-sm ${classes.text}`}
                                >
                                  API Key
                                </span>
                              ...
                              <code
                                className={`${classes.card} px-3 py-2 rounded-lg text-sm block font-mono border ${classes.border}`}
                              >
                            ...
                            >
                              ...
                              <p className={`text-sm ${classes.textSecondary}`}>
                                Your IP must be whitelisted. Contact admin to
                                add your IP.
                              </p>
                            </div>
                          </div>
                      ...
                      {activeTab === "response" && (
                        ...
                        >
                          <h3
                            className={`font-semibold mb-4 ${classes.text} flex items-center gap-2`}
                          >
                            {responseError ? (
                          ...
                          {loading ? (
                            ...
                            <div className="space-y-4">
                              <div
                                className={`${classes.codeBg} rounded-xl border ${classes.border} p-4 overflow-x-auto max-h-[500px] overflow-y-auto`}
                              >
                            ...
                            <div
                              className={`p-4 ${classes.bgSecondary} rounded-xl border ${classes.border} border-red-500/30`}
                            >
                              <p
                                className={`text-xs ${classes.textMuted} mb-2 flex items-center gap-1`}
                              >
                              ...
                              <div
                                className={`${classes.codeBg} rounded-lg p-4 overflow-x-auto`}
                              >
                            ...
                            <div
                              className={`p-8 text-center ${classes.textMuted}`}
                            >
                    ...
                    >
                      <div className="flex justify-between items-center mb-4">
                        <h3
                          className={`font-semibold flex items-center gap-2 ${classes.text}`}
                        >
                          <Clock
                            size={18}
                            className={
